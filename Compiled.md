...
Ранее мы уже встречали множество модификаторов таких, как `public`, `private`, `final` и так далее. Здесь мы поговорим когда, где и как уместно их использовать.

### Модификаторы доступа

> Будьте бдительны! (с) Цопа

Есть 4 вида доступа ко внутренним свойствам класса:

* `package-private` - модификатор доступа по умолчанию. Его нельзя прописать вручную, так как в этом нет необходимости - можно просто не указывать модификатор доступа. Ограничивает область видимости пакетом класса, внутри которого он объявлен.
