...
- `stack` - максимальный размер стека операндов, необходимый для выполнения процедуры (важно понимать, что это стек операндов, а не стек потока программы)
...
Возвращаемся к стеку и к листингу 2.1:
*Листинг 2.1 DataExample.java*
